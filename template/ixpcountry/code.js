...
//Global Variables
var rows, cols, cells, row_count, col_count, row_by_idx, data_n, proto, uniq_asns = [], filter_ASNs, _6to4, mtype;
...
function redraw(){
    ...
    if(row_count_f > 0){
        plot_vizualization(rows_f, cols_f, cells_f, row_count_f, col_count_f, row_by_idx_f, col_by_idx_f);
    }
...
function plot_vizualization(rows, cols, cells, row_count, col_count, row_by_idx, col_by_idx) {
